...
import { useCreateVariantSet } from "@/features/variants/queries";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <DialogTitle>Generate from a brief</DialogTitle>
          <DialogDescription>Pick a Prompt Builder brief to generate 5 directions from.</DialogDescription>
        </DialogHeader>
